...
# With the assumption that the data is of normal distribution and follows linear
# regression beta0 being 21.86, indicates that is your progression if BMI was 0, 
# this is unrealistic as no one has this, the slope being beta1 and 0.31 indicates
...
correlations <- sapply(predictor_vars, function(var) {
  cor(diabetes[[var]], diabetes$target)
})
